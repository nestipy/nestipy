...
def codegen_client(modules: list[Type], output: str, *, language: str = "python", class_name: str = "ApiClient", prefix: str = "") -> None:
...
def codegen_client_from_url(url: str, output: str, *, language: str = "python", class_name: str = "ApiClient") -> None:
