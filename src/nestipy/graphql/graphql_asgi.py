...
from nestipy.core.ioc.nestipy_context_container import NestipyContextContainer
...
class GraphqlAsgi:
    ...
    def _setup_request(cls, scope: dict, receive, send):
        ...
        NestipyContextContainer.get_instance().set_value(NestipyContainerKey.request, req)
        pass
