...
export class ApiClient {
  ...
  async message(options?: {}): Promise<string> {
  ...
  async ping(options?: {}): Promise<string> {
    let path = "/api/ping";
    const queryParams = options?.query;
    const headerParams = options?.headers;
    const jsonBody = options?.body;
  ...
  async csrf(options?: {}): Promise<Record<string, unknown>> {
  ...
  async handle(options?: { body?: ActionsControllerHandleBody }): Promise<Record<string, unknown>> {
    let path = "/_actions";
    const queryParams = options?.query;
    const headerParams = options?.headers;
    const jsonBody = options?.body;
  ...
  async schema(options?: {}): Promise<Record<string, unknown>> {
